...
export default function SettingsForm({ onSave, onCancel, initialData }: SettingsFormProps) {
      ...
      <GlassCard className="p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label className="text-xs font-black text-slate-500 uppercase">الاسم</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-black text-slate-500 uppercase">نظام الدوام</label>
            <select 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-black text-slate-500 uppercase">تاريخ بداية الدورة</label>
            <input 
              type="date"
